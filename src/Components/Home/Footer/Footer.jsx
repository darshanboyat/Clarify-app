...
export default function SimpleContainer() {
    const linkList = [{ title: "Sign up", link: "/signup" }, { title: "Sign in", link: "/signin" }, { title: "Terms and Conditions", link: "/tandc" }, { title: "Privacy Policy", link: "/policy" }, { title: "Contact Us", link: "/contact" }]
    ...
    return (
        <React.Fragment>
            <CssBaseline />
            <Container maxWidth="100%" sx={{ bgcolor: '#0c4d71', height: '50.9vh' }}>
                <Box className="footer-container">
                    ...
                    <Box className="footer-copyright">
                        Copyright &copy; IHTIRAF. Made with love by Brain Inventory.
                    </Box>
                </Box>
            </Container>
        </React.Fragment>
